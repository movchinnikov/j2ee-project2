...
public interface OutboxEventRepository extends JpaRepository<OutboxEventEntity, UUID> {
    ...
    /** Find the oldest PENDING events for the relay scheduler (batch of 50). */
    ...
    /** Mark a set of events as PROCESSED. */
    @Modifying
    ...
    /** Mark a single event as FAILED with an error message. */
    @Modifying
